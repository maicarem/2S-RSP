...
function main_program()
    ...
    # function my_callback_lazy(cb_data)
    #     x_hat = callback_value.(cb_data, x)
    #     y_hat = callback_value.(cb_data, y)
    ...
    # set_attribute(master, MOI.LazyConstraintCallback(), my_callback_lazy)
